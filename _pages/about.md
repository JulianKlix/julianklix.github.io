...
{% if site.links.crc_website and site.links.crc_website != "" %}<a href="{{ site.links.personal_website }}" target="_blank" class="icon-link" title="Personal Website"><svg class="icon icon-crc" aria-hidden="true"><use xlink:href="/assets/icons/CRCTR224.svg#icon-crc"></use></svg></a>{% endif %}
