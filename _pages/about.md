...
{% if site.links.crc_website and site.links.crc_website != "" %}<a href="{{ site.links.crc_website }}" target="_blank" class="icon-link" title="CRC Website"><svg class="icon icon-crc" aria-hidden="true"><use xlink:href="/assets/icons/CRCTR224.svg#icon-crc"></use></svg></a>{% endif %}
