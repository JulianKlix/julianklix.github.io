...
<a href="{{ site.url }}{{ site.baseurl }}/papers/ParasocialMarketing PDF.pdf" class="chip">Starters</a>
<a href="{{ site.url }}{{ site.baseurl }}/papers/ParasocialMarketing PDF.pdf" class="chip">Sides</a>
